...
export class VerificationController {
  ...
  @Roles('TEACHER') @Put('teacher/profile/intro-video') video(@CurrentUser() user: AuthUser, @Body() body: IntroVideoDto) { return this.service.introVideo(user.id, body.fileId); }
