...
async function seedTicketsCmsAndSettings() {
  ...
  const pages = [
    ...
    {
      slug: 'contact', titleFa: 'تماس با ما', titleEn: 'Contact us',
      contentFa: { paragraphs: [
    ...
    {
      slug: 'terms', titleFa: 'قوانین و مقررات', titleEn: 'Terms of use',
      contentFa: { paragraphs: [
    ...
    {
      slug: 'privacy', titleFa: 'سیاست حفظ حریم خصوصی', titleEn: 'Privacy policy',
      contentFa: { paragraphs: [
    ...
    {
      slug: 'cancellation-policy', titleFa: 'سیاست لغو و بازپرداخت', titleEn: 'Cancellation and refund policy',
      contentFa: { paragraphs: [
    ...
    {
      slug: 'become-a-teacher', titleFa: 'مدرس شوید', titleEn: 'Become a teacher',
      contentFa: { paragraphs: [
