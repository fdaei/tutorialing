...
export const messages = {
  fa: {
    ...
    adminTestLanguage: 'زبان آموزشی',
    adminTestSelectLanguage: 'زبان آموزشی را انتخاب کنید',
  ...
  en: {
    ...
    adminTestLanguage: 'Educational language',
    adminTestSelectLanguage: 'Select an educational language',
