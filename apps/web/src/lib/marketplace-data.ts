...
export const teachers: Teacher[] = [
  {
    slug: 'sara-mohammadi',
    name: 'سارا محمدی',
    languages: 'انگلیسی و آلمانی',
    specialty: 'مکالمه و آمادگی آزمون',
    rating: 4.9,
    satisfaction: 98,
    students: 186,
    price: 390000,
  ...
  },
  {
    ...
    name: 'امیر حسینی',
    languages: 'فرانسوی',
    specialty: 'مکالمه روزمره و مهاجرت',
    rating: 4.8,
    satisfaction: 96,
    students: 142,
    price: 340000,
  ...
  },
  {
    ...
    name: 'مریم کریمی',
    languages: 'آلمانی',
    specialty: 'گوته و زبان دانشگاهی',
    rating: 4.9,
    satisfaction: 99,
    students: 211,
    price: 420000,
    image: '/images/auth/verify.png',
  },
  {
    slug: 'nima-yousefi',
    name: 'نیما یوسفی',
    languages: 'اسپانیایی و انگلیسی',
    specialty: 'مکالمه فشرده',
    rating: 4.7,
    satisfaction: 95,
    students: 98,
    price: 320000,
...
export const courses: Course[] = [
  ...
  },
  {
    ...
    title: 'اسپانیایی برای زندگی روزمره',
    language: 'اسپانیایی',
    flag: '🇪🇸',
    level: 'A2',
    teacher: 'نیما یوسفی',
...
export const posts: BlogPost[] = [
  {
    slug: 'daily-language-plan',
    category: 'برنامه‌ریزی',
    title: 'چطور هر روز برای زبان وقت پیدا کنیم؟',
    excerpt: 'یک برنامه ساده و قابل اجرا برای ساختن عادت یادگیری، حتی در روزهای شلوغ.',
    date: '۶ شهریور ۱۴۰۵',
    readTime: '۶ دقیقه',
    image: '/images/auth/forgot.png',
  },
  {
    slug: 'remember-vocabulary',
    category: 'یادگیری',
    title: '۱۰ راه علمی برای ماندگار کردن لغت‌ها',
    excerpt: 'روش‌هایی که کمک می‌کنند واژه‌های تازه از حافظه کوتاه‌مدت عبور کنند.',
    date: '۳ شهریور ۱۴۰۵',
    readTime: '۸ دقیقه',
    image: '/images/auth/register.png',
  },
  {
    ...
    category: 'مکالمه',
    title: 'چطور بدون ترس شروع به صحبت کنیم؟',
    excerpt: 'تمرین‌های کوتاه برای کاهش اضطراب و روان‌تر شدن مکالمه به زبان جدید.',
    date: '۱ شهریور ۱۴۰۵',
    readTime: '۵ دقیقه',
    image: cityImage,
  },
