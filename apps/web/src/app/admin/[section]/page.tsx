...
export default async function Section({ params }: { params: Promise<{ section: string }> }) {
  ...
  else if(section==='bookings')content=<div className="grid gap-6"><TeacherPlannerCalendar mode="admin"/><PanelActions role="admin" section={section} endpoint={endpoint}/><ResourceView title={fa?titleFa:titleEn} endpoint={endpoint}/></div>;
