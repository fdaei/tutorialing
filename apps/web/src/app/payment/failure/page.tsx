  ...
  return (
    <main className="grid min-h-screen place-items-center p-6">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="mt-5 text-3xl font-black sm:text-4xl">{fa ? 'پرداخت ناموفق بود' : 'Payment failed'}</h1>
