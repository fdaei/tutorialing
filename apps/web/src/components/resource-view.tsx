...
function format(value:unknown,key:string,locale:Locale){
  ...
  if(locale==='fa'&&typeof value==='string'&&faStatus[value])return faStatus[value];
  return String(value);
}
