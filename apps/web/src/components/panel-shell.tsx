...
export type NavItem={href:string;label:string;labelEn:string;icon?:React.ElementType};
...
export function PanelShell({title,items,children}:{title:string;items:NavItem[];children:React.ReactNode}){
 ...
 const me=useQuery({queryKey:['panel-me'],queryFn:()=>api<{name?:string;roles:string[]}>('/users/me'),retry:false});
...
export const adminNav:NavItem[]=[
 {href:'/admin',label:'داشبورد',labelEn:'Dashboard',icon:Grid2X2},
 {href:'/admin/search',label:'جستجوی سراسری',labelEn:'Global search',icon:Search},
 {href:'/admin/users',label:'کاربران',labelEn:'Users',icon:Users},
 {href:'/admin/teachers',label:'مدرس‌ها',labelEn:'Teachers',icon:Users},
 {href:'/admin/teacher-applications',label:'درخواست‌های مدرس',labelEn:'Teacher applications',icon:FileCheck},
 {href:'/admin/teacher-documents',label:'مدارک مدرس',labelEn:'Teacher documents',icon:FileCheck},
 {href:'/admin/teacher-prices',label:'تأیید قیمت مدرس',labelEn:'Teacher price approvals',icon:CreditCard},
 {href:'/admin/languages',label:'زبان‌ها',labelEn:'Languages'},
 {href:'/admin/tests',label:'آزمون‌ها',labelEn:'Tests',icon:BookOpen},
 {href:'/admin/test-reviews',label:'تصحیح آزمون',labelEn:'Test reviews',icon:FileCheck},
 {href:'/admin/bookings',label:'رزروها',labelEn:'Bookings',icon:CalendarDays},
 {href:'/admin/availability-blocks',label:'مسدودی‌های زمان',labelEn:'Availability blocks',icon:CalendarDays},
 {href:'/admin/tickets',label:'تیکت‌ها',labelEn:'Tickets',icon:TicketCheck},
 {href:'/admin/finance',label:'امور مالی',labelEn:'Finance',icon:CreditCard},
 {href:'/admin/discounts',label:'کدهای تخفیف',labelEn:'Discounts'},
 {href:'/admin/refunds',label:'بازپرداخت‌ها',labelEn:'Refunds'},
 {href:'/admin/teacher-earnings',label:'درآمد مدرس‌ها',labelEn:'Teacher earnings'},
 {href:'/admin/payouts',label:'تسویه‌ها',labelEn:'Payouts'},
 {href:'/admin/reviews',label:'نظرات',labelEn:'Reviews'},
 {href:'/admin/roles',label:'نقش‌ها و مجوزها',labelEn:'Roles & permissions',icon:ShieldCheck},
 {href:'/admin/cms',label:'مدیریت محتوا',labelEn:'CMS'},
 {href:'/admin/notifications',label:'اعلان‌ها',labelEn:'Notifications',icon:Bell},
 {href:'/admin/audit',label:'لاگ فعالیت',labelEn:'Audit logs'},
 {href:'/admin/settings',label:'تنظیمات',labelEn:'Settings',icon:Settings}
];
