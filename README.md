...
seed فقط برای محیط‌های محلی و آزمایشی است، از شماره‌های رزروشدهٔ ساختگی استفاده
می‌کند و در `NODE_ENV=production` عمداً متوقف می‌شود. اطلاعات ورود یا کد OTP
ثابت در مستندات عمومی نگهداری نمی‌شود.
